/*Desenvolva um programa em C que calcule a média ponderada de um aluno com base em quatro notas e diferentes pesos atribuídos a cada nota. O usuário deve poder escolher um dos três métodos de cálculo de média:
